#+TITLE: Any large-scale fanfictions where there's multiple teamups of very different people that try to take on an evil that isn't contained to magical Britain only?
